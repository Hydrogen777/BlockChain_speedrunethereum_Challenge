...
contract MyUSDEngine is Ownable {
    ...
    function repayUpTo(uint256 amount) public {
        ...
        // Kiểm tra nếu người dùng trả quá số nợ hiện tại
        ...
        // Kiểm tra số dư MyUSD của người dùng
