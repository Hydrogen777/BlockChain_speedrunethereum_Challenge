...
contract DEX {
    ...
    function ethToToken() public payable returns (uint256 tokenOutput) {
        ...
        require(token.transfer(msg.sender, tokenOutput), "ethToToken: revert in transferring tokens to you!");
    ...
    function deposit() public payable returns (uint256 tokensDeposited) {
        ...
        // Calculate amount of tokens needed to match the ratio of ETH deposited
        // Using +1 to prevent rounding errors favoring the user slightly
